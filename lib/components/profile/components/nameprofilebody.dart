...
class nameprofilebody extends StatefulWidget {
  ...
  @override
  State<nameprofilebody> createState() => _nameprofilebodyState();
}

class _nameprofilebodyState extends State<nameprofilebody> {
  final GlobalKey<FormState> _form = GlobalKey<FormState>();

  TextEditingController _editname = TextEditingController();
  void initState() {
    _editname = TextEditingController(text: widget.username);
